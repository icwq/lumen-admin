 ...
 * @property AdminLogService $adminLogService 管理员操作日志服务
 * @property SettingService $settingService 系统配置服务
 *
...
class Service
{
    ...
    private $childService = [
        ...
        'adminLogService' => AdminLogService::class,
        'settingService' => SettingService::class,
    ];
